...
const Services = ({ standalone = false, preview = false, moreHref = '/services' }: SectionPageProps) => {
  const sectionPad = standalone ? 'pt-28 pb-24' : 'py-24';

  return (
    <section id="services" className={`${sectionPad} bg-white relative overflow-hidden`}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <p className="text-sm font-semibold text-[#2563EB] uppercase tracking-widest mb-3">What We Offer</p>
      ...
      {preview && moreHref && <SectionMoreLink to={moreHref} label="Explore all services" />}
    </section>
  );
};
