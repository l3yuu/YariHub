...
const ProfileCardComponent = ({
  ...
  // Glare overlay that follows pointer
      ...
      <div ref={shellRef} className="relative z-[1] group h-full">
        ...
        >
          ...
          >
            ...
            {/* Avatar content (Removed image to rely on typography and gradients) */}
            <div
            ...
            >
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex flex-col justify-between backdrop-blur-[30px] border border-white/10 pointer-events-auto"
                  style={{
                    '--ui-inset': '20px',
                    '--ui-radius-bias': '6px',
                    bottom: 'var(--ui-inset)',
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="rounded-full overflow-hidden border border-white/20 flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-white/20 to-white/5"
                      style={{ width: '48px', height: '48px' }}
                    >
                      <span className="text-xl font-bold text-white shadow-sm drop-shadow-md">
                  ...
                  {onContactClick && (
                    <button
                      className="border border-white/10 rounded-lg px-4 py-3 text-xs font-semibold text-white/90 cursor-pointer backdrop-blur-[10px] transition-all duration-200 ease-out hover:border-white/40 hover:-translate-y-px mt-3 w-full"
            ...
            {/* Details content */}
            <div
              className="max-h-full overflow-hidden text-center absolute inset-0 z-[5] flex flex-col items-center justify-center pb-20"
              style={{
                transform:
            ...
            >
              <div className="w-full flex flex-col items-center pointer-events-auto">
                <h3
                  className="font-semibold m-0 px-4 leading-tight text-center"
                  style={{
                    fontSize: 'min(3.5svh, 2.2em)',
                    backgroundImage: 'linear-gradient(to bottom, #fff, #b8b8ff)',
                ...
                <p
                  className="font-medium mx-auto w-[90%] text-center mt-2"
                  style={{
                    fontSize: 'min(2svh, 1em)',
                    color: '#ffffff88',
                    display: 'block'
                  }}
                >
