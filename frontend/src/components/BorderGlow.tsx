...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '220 80 80', // Default to a blue-ish hue for YariHub
  ...
  coneSpread = 20,
  animated = false,
  colors = ['#3b82f6', '#8b5cf6', '#6366f1'], // YariHub blue/violet palette
  fillOpacity = 0.4,
}) => {
  ...
  return (
    <div
      ...
      style={{
        ...
        // Removed default box shadow to let BorderGlow shine
      }}
    >
      ...
      <div className="flex flex-col relative h-full w-full overflow-auto z-[1]">
        {children}
      </div>
    </div>
  );
