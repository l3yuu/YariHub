  ...
  return (
    ...
    >
      <BorderGlow
        ...
        borderRadius={round ? 9999 : 40}
        backgroundColor="rgba(255, 255, 255, 0.05)" // Subtle transparency for glass effect
        edgeSensitivity={20}
        glowRadius={30}
...
export default function Carousel({
  ...
  return (
    ...
    >
      ...
      <div className={`flex w-full justify-center ${round ? 'absolute z-20 bottom-12 left-1/2 -translate-x-1/2' : 'absolute bottom-6'}`}>
        <div className="flex w-[180px] justify-between px-8 bg-white/10 backdrop-blur-md rounded-full py-2">
